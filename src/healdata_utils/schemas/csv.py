healcsvschema = {
    ...
    "patternProperties": {
        "^standardsMappings[\\d+].instrument.url$": {
            ...
            "names:\n"
            "`standardsMappings[0].instrument.url`\t"
            "`standardsMappings[1].instrument.url`\t"
            "`standardsMappings[2].instrument.url`\n"
            "\n",
            "type": "string",
            "format": "uri",
            "examples": [
        ...
        "^standardsMappings[\\d+].instrument.source$": {
            ...
            "names:\n"
            "`standardsMappings[0].instrument.source`\t"
            "`standardsMappings[1].instrument.source`\t"
            "`standardsMappings[2].instrument.source`\n"
            "\n",
            "enum": ["heal-cde"],
        },
        "^standardsMappings[\\d+].instrument.title$": {
            ...
            "`standardsMappings[2].instrument.title`\n"
            "\n",
        },
        "^standardsMappings[\\d+].instrument.id$": {
            ...
            "names:\n"
            "`standardsMappings[0].instrument.id`\t"
            "`standardsMappings[1].instrument.id`\t"
            "`standardsMappings[2].instrument.id`\n"
            "\n",
            "examples": ["5141"],
        },
        "^standardsMappings[\\d+].item.url$": {
            ...
            "names:\n"
            "`standardsMappings[0].item.url`\t"
            "`standardsMappings[1].item.url`\t"
            "`standardsMappings[2].item.url`\n"
            "\n",
            "type": "string",
            "format": "uri",
            "examples": [
        ...
        "^standardsMappings[\\d+].item.source$": {
            ...
            "names:\n"
            "`standardsMappings[0].item.source`\t"
            "`standardsMappings[1].item.source`\t"
            "`standardsMappings[2].item.source`\n"
            "\n",
            "examples": ["CDISC"],
            "type": "string",
        },
        "^standardsMappings[\\d+].item.id$": {
            ...
            "names:\n"
            "`standardsMappings[0].item.id`\t"
            "`standardsMappings[1].item.id`\t"
            "`standardsMappings[2].item.id`\n"
            "\n",
            "examples": ["C74457"],
        },
        ...
        "^relatedConcepts[\\d+].source$": {
            ...
            "names:\n"
            "`relatedConcepts[0].source`\t"
            "`relatedConcepts[1].source`\t"
            "`relatedConcepts[2].source`\n"
            "\n",
            "type": "string",
        ...
        "^relatedConcepts[\\d+].id$": {
            ...
            "names:\n"
            "`relatedConcepts[0].id`\t"
            "`relatedConcepts[1].id`\t"
            "`relatedConcepts[2].id`\n"
            "\n",
            "examples": ["27808", "3304"],
        },
    },
